...
| `test_title_label.py` | The header bar title label survives extents queries while its text churns — a GTK `GtkLabel` NULL-layout crash Ghostty works around. Its pty storms the title; it turns the header bar on. |
